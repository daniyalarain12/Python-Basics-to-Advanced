...
set1 = {1,2,3}
set2 = {2,3,4}
print("UNION :",set1.union(set2))                  # COMBINES BOTH SET VALUES AND RETURNS NEW SET

print("INTERSECTION :",set1.intersection(set2))    # COMBINES COMMON VALUES AND RETURNS NEW SET 
